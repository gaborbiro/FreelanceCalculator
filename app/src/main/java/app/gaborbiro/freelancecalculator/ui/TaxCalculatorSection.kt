...
@Composable
fun TaxCalculatorSection(taxModel: TaxCalculatorUIModel, store: Store) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(
        ...
        Row {
            ...
            Column(
                ...
                AnimatedVisibility(
                    ...
                    TaxCalculatorEntry(title = "Income tax:", value = taxModel.incomeTax)
                }
                ...
                AnimatedVisibility(
                    ...
                    TaxCalculatorEntry(title = "NIC2:", value = taxModel.nic2Tax)
                }
                ...
                AnimatedVisibility(
                    ...
                    TaxCalculatorEntry(title = "NIC4:", value = taxModel.nic4Tax)
                }
                if (expanded != false) {
                    Divider(
                        modifier = Modifier
                ...
                TaxCalculatorEntry(title = "Total tax:", value = taxModel.totalTax)
            }
...
@Composable
private fun TaxCalculatorEntry(title: String, value: String) {
    Row {
        Text(
            modifier = Modifier
                .weight(.4f)
...
class TaxCalculatorUIModel(
    ...
    companion object {
        fun dummyData() = TaxCalculatorUIModel(
...
private fun TaxSectionPreview() {
    Column(
        ...
        TaxCalculatorSection(
            taxModel = TaxCalculatorUIModel.dummyData(),
