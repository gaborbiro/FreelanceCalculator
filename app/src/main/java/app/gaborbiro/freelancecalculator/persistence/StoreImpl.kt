...
internal open class StoreImpl(context: Context, scope: CoroutineScope) :
    StoreBase(context, scope), Store {

    override var pinnedSectionIndex: MutableStateFlow<Int> =
        intDelegate("PINNED_SECTION_INDEX", default = 2)
    ...
    override val sectionExpander: MapPrefsDelegate<Boolean> =
        booleanMapPrefsDelegate("SECTION_EXPANDED")
